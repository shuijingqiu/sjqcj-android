 ...
 */
public class MoreDynamicExpertRecommendActivity extends Activity{
    ...
    private void findView() {
        findViewById(R.id.more_tv).setVisibility(View.VISIBLE);
        ((TextView)findViewById(R.id.title_tv)).setText("牛人交易推荐");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                inten.setClass(MoreDynamicExpertRecommendActivity.this, SharesDetailedActivity.class);
                startActivity(inten);
            }
        });
    ...
    private void getData(){
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                resstr = HttpUtil.restHttpGet(Constants.moUrl+"/orders&token="+Constants.apptoken+"&uid="+Constants.staticmyuidstr+"&recommend=1&p="+page);
...
//                            CustomToast.makeText(getActivity(), jsonObject.getString("data"), Toast.LENGTH_SHORT).show();
    ...
    public void moreClick(View view){
        ...
        Intent intent = new Intent(this,
                MoreDynamicExpertActivity.class);
