...
import com.example.sjqcjstock.fragment.stocks.FragmentDynamicExpert;
 ...
 */
public class ExpertSubscriptionActivity extends FragmentActivity implements ViewPager.OnPageChangeListener{
    ...
    // 牛人动态Fragment
    private FragmentDynamicExpert bdList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.activity_expert_subscription);
        // 将Activity反复链表
    ...
    private void initFragment() {
        bdList = new FragmentDynamicExpert();
        FragmentDynamicOrder skLIst = new FragmentDynamicOrder();
        mDatas.add(bdList);
        mDatas.add(skLIst);
