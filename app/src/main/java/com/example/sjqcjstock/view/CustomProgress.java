...
//    }
     ...
     *            上下文
     */
    public CustomProgress setData(Context context) {
        ...
        TextView txt = (TextView) dialog.findViewById(R.id.message);
        txt.setText(Constants.loadMessage);
        // 设置居中
        dialog.getWindow().getAttributes().gravity = Gravity.CENTER;
        WindowManager.LayoutParams lp = dialog.getWindow().getAttributes();
        // 设置背景层透明度
     ...
     * 设置按返回键是否取消
     */
    public void setCancelableDialog(boolean isRn){
        dialog.setCancelable(isRn);
    }
